...
BlocklyDuino.selectedToolbox = 'toolbox_algo'; //Preset
...
BlocklyDuino.changeToolbox = function () {
	...
	window.location = window.location.protocol + '//'+ window.location.host + window.location.pathname + "sortby=C";
};
...
BlocklyDuino.init = function() {
	...
	if (BlocklyDuino.getSize() != '') {
		...
		// minimize div
		//$("#divTabpanel").css({"margin-right" : "205px"});
