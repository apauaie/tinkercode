...
/* SY */
/*
Blockly.Arduino.tuah = {};
Blockly.Arduino.tuah_led = function() {
    var a = this.getFieldValue("LEDx"),
        b = this.getFieldValue("STAT");
    return "bot.LED(" + a + ',"' + b + '");\n'
};
Blockly.Arduino.tuah_megablink = function() {
    var a = Blockly.Arduino.valueToCode(this, "DELAY", Blockly.Arduino.ORDER_ATOMIC);
    Blockly.Arduino.definitions_.define_tuah = "#include <Tuah.h>\n";
    Blockly.Arduino.definitions_.var_tuah = "Tuah bot;\n";
    return "bot.megablink(" + a + ");\n"
};
Blockly.Arduino.tuah_knightrider = function() {
    var a = Blockly.Arduino.valueToCode(this, "DELAY", Blockly.Arduino.ORDER_ATOMIC);
    Blockly.Arduino.definitions_.define_tuah = "#include <Tuah.h>\n";
    Blockly.Arduino.definitions_.var_tuah = "Tuah bot;\n";
    return "bot.knightrider(" + a + ");\n"
};
Blockly.Arduino.tuah_motor_steer = function() {
    ...
    Blockly.Arduino.definitions_.define_tuah = "#include <Tuah.h>\n";
    Blockly.Arduino.definitions_.var_tuah = "Tuah bot;\n";
    return 'bot.motorsteer("' + a + '",' + b + ");\n"
};
Blockly.Arduino.tuah_motor_tank = function() {
    var a = this.getFieldValue("DIRL"),
        b = this.getFieldValue("DIRR"),
        c = Blockly.Arduino.valueToCode(this, "SPEEDL", Blockly.Arduino.ORDER_ATOMIC),
        d = Blockly.Arduino.valueToCode(this, "SPEEDR", Blockly.Arduino.ORDER_ATOMIC);
    Blockly.Arduino.definitions_.define_tuah = "#include <Tuah.h>\n";
    Blockly.Arduino.definitions_.var_tuah = "Tuah bot;\n";
    return 'bot.motortank("' + a + '",' + c + ',"' + b + '",' + d + ");\n"
};
Blockly.Arduino.tuah_ultrasonic_read = function() {
    Blockly.Arduino.definitions_.define_tuah = "#include <Tuah.h>\n";
    Blockly.Arduino.definitions_.var_tuah = "Tuah bot;\n";
    return ["bot.ultrasonic();", Blockly.Arduino.ORDER_ATOMIC]
};
Blockly.Arduino.tuah_linesensor = function() {
    var a = this.getFieldValue("sensorx");
    Blockly.Arduino.definitions_.define_tuah = "#include <Tuah.h>\n";
    Blockly.Arduino.definitions_.var_tuah = "Tuah bot;\n";
    return ["bot.ir_sense(" + a + ");", Blockly.Arduino.ORDER_ATOMIC]
};

Blockly.Arduino.eureqa = {};
...
Blockly.Arduino.eureqa_motor_move = function() {
    var a;
    var b = this.getFieldValue("DIR");
    var c = Blockly.Arduino.valueToCode(this, "SPEED", Blockly.Arduino.ORDER_ATOMIC);
    if ("stop" == b) {
        var d = b = "LOW";
        c = a = 0
    } else d = b = "HIGH", a = c;
    ...
    Blockly.Arduino.setups_.setup_motordir_B = "pinMode(18, OUTPUT);";
    return "digitalWrite(5," + a + ");\n" +
        ("digitalWrite(6," + c + ");\n") + ("digitalWrite(17," + b + ");\n") + ("digitalWrite(18," + d + ");\n")
};
*/